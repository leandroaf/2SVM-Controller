...
public final class AppMsgDataReader extends DataReader  {
  
  AppMsgDataReader (Subscriber             s,
                        TopicDescription       td,
                        SWIGTYPE_p__DataReader j_dr) {
     super(s,td,j_dr);
  }
  public ReturnCode_t    read( AppMsgSeq                   received_data,
    ...
    ReturnCode_t retval =  _read(tmp_seq, sample_infos, max_samples,
                                 ...
                                 AppMsg.class);
    received_data.value = (AppMsg[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    read_w_condition( AppMsgSeq       received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
    ...
    ReturnCode_t retval =  _read_w_condition(tmp_seq, sample_infos, max_samples,
                                 condition, AppMsg.class);
    received_data.value = (AppMsg[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    read_next_sample( AppMsg          received_data,
                                    SampleInfo  sample_info) {
    ReturnCode_t retval;
    AppMsgSeq tmp_seq = new AppMsgSeq();
  ...
  public ReturnCode_t    read_instance( AppMsgSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
  ...
  public ReturnCode_t    read_next_instance( AppMsgSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
  ...
  public ReturnCode_t    read_next_instance_w_condition( AppMsgSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 ReadCondition           condition) {
    ...
    ReturnCode_t retval =  _read_next_instance_w_condition(tmp_seq, sample_infos, max_samples,
                                 handle, condition, AppMsg.class);
    received_data.value = (AppMsg[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    take( AppMsgSeq                   received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 long                    sample_states,
			 long                    view_states,
  ...
  public ReturnCode_t    take_w_condition( AppMsgSeq       received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 ReadCondition           condition) {
    sample_infos.value  = null;
  ...
  public ReturnCode_t    take_next_sample( AppMsg          received_data,
                                    SampleInfo  sample_info) {
    ReturnCode_t retval;
    AppMsgSeq tmp_seq = new AppMsgSeq();
    SampleInfoSeq si_seq = new SampleInfoSeq();
  ...
  public ReturnCode_t    take_instance( AppMsgSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 long                    sample_states,
  ...
  public ReturnCode_t    take_next_instance( AppMsgSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        prev_handle,
			 long                    sample_states,
  ...
  public ReturnCode_t    take_next_instance_w_condition( AppMsgSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 ReadCondition           condition) {
  ...
  public ReturnCode_t    return_loan( AppMsgSeq                   received_data,
                                      SampleInfoSeq           sample_infos) {
    ReturnCode_t retval =  _return_loan(null, sample_infos);
    return retval;
  }
  public ReturnCode_t     get_key_value(AppMsg                  key_holder,
                                        InstanceHandle_t    handle) {
    ReturnCode_t retval  = _get_key_value(key_holder, handle);
    return retval;
  }
  public InstanceHandle_t lookup_instance(AppMsg                  instance_data) {
