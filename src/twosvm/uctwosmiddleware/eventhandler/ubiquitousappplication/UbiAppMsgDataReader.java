...
public final class UbiAppMsgDataReader extends DataReader {

	UbiAppMsgDataReader(Subscriber s, TopicDescription td,
			SWIGTYPE_p__DataReader j_dr) {
		super(s, td, j_dr);
	}

	public ReturnCode_t read(UbiAppMsgSeq received_data,
		...
		ReturnCode_t retval = _read(tmp_seq, sample_infos, max_samples,
				sample_states, view_states, instance_states, UbiAppMsg.class);
		received_data.value = (UbiAppMsg[]) tmp_seq.value;
		return retval;
	}

	public ReturnCode_t read_w_condition(UbiAppMsgSeq received_data,
		...
		ReturnCode_t retval = _read_w_condition(tmp_seq, sample_infos,
				max_samples, condition, UbiAppMsg.class);
		received_data.value = (UbiAppMsg[]) tmp_seq.value;
		return retval;
	}

	public ReturnCode_t read_next_sample(UbiAppMsg received_data,
			SampleInfo sample_info) {
		ReturnCode_t retval;
		UbiAppMsgSeq tmp_seq = new UbiAppMsgSeq();
	...
	public ReturnCode_t read_instance(UbiAppMsgSeq received_data,
		...
		ReturnCode_t retval = _read_instance(tmp_seq, sample_infos,
				...
				instance_states, UbiAppMsg.class);
		received_data.value = (UbiAppMsg[]) tmp_seq.value;
		return retval;
	}

	public ReturnCode_t read_next_instance(UbiAppMsgSeq received_data,
			SampleInfoSeq sample_infos, int max_samples,
	...
	public ReturnCode_t read_next_instance_w_condition(
			UbiAppMsgSeq received_data, SampleInfoSeq sample_infos,
		...
		ReturnCode_t retval = _read_next_instance_w_condition(tmp_seq,
				sample_infos, max_samples, handle, condition, UbiAppMsg.class);
		received_data.value = (UbiAppMsg[]) tmp_seq.value;
		return retval;
	}

	public ReturnCode_t take(UbiAppMsgSeq received_data,
			SampleInfoSeq sample_infos, int max_samples, long sample_states,
			long view_states, long instance_states) {
		sample_infos.value = null;
		SampleSeq tmp_seq = new SampleSeq();
	...
	public ReturnCode_t take_w_condition(UbiAppMsgSeq received_data,
			SampleInfoSeq sample_infos, int max_samples, ReadCondition condition) {
		sample_infos.value = null;
		SampleSeq tmp_seq = new SampleSeq();
	...
	public ReturnCode_t take_next_sample(UbiAppMsg received_data,
			SampleInfo sample_info) {
		ReturnCode_t retval;
		UbiAppMsgSeq tmp_seq = new UbiAppMsgSeq();
		SampleInfoSeq si_seq = new SampleInfoSeq();
	...
	public ReturnCode_t take_instance(UbiAppMsgSeq received_data,
			SampleInfoSeq sample_infos, int max_samples,
			InstanceHandle_t handle, long sample_states, long view_states,
			long instance_states) {
		sample_infos.value = null;
	...
	public ReturnCode_t take_next_instance(UbiAppMsgSeq received_data,
			SampleInfoSeq sample_infos, int max_samples,
			InstanceHandle_t prev_handle, long sample_states, long view_states,
			long instance_states) {
		sample_infos.value = null;
	...
	public ReturnCode_t return_loan(UbiAppMsgSeq received_data,
			SampleInfoSeq sample_infos) {
		ReturnCode_t retval = _return_loan(null, sample_infos);
		return retval;
	}

	public ReturnCode_t get_key_value(UbiAppMsg key_holder,
			InstanceHandle_t handle) {
		ReturnCode_t retval = _get_key_value(key_holder, handle);
		return retval;
	}

	public InstanceHandle_t lookup_instance(UbiAppMsg instance_data) {
