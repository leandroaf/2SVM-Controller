...
public class ContextChangeMsg {
	...
	// constructors
	public ContextChangeMsg() {
	}

	public ContextChangeMsg(String __f1, String __f2, String __f3, String __f4,
	...
	public void copy(ContextChangeMsg from) {
